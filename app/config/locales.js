export let LOCALES = {
  ...
  es:{
    ...
    "i.finish_screen_title_full":"El contenido ha terminado. Puedes cerrar esta ventana. Su progreso final fue de#{progress_measure}% y su puntuación final fue #{score}%.",
    "i.finish_screen_title_wpm":"El contenido ha terminado. Puedes cerrar esta ventana. Su progreso final fue de #{progress_measure}%.",
    "i.finish_screen_title_ws":"El contenido ha terminado. Puedes cerrar esta ventana. Su puntuación final fue de #{score}%.",
