export let LOCALES = {
  ...
  es:{
    ...
    "i.finish_screen_title_full":"El contenido ha terminado. Puedes cerrar esta ventana. El progreso final ha sido de #{progress_measure}% y su puntuación final fue de #{score}%.",
