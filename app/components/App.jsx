  ...
  render(){
    ...
    if((this.props.tracking.finished !== true) || (GLOBAL_CONFIG.finish_screen === false)){
      ...
      if(this.props.wait_for_user_profile !== true){
        appContent = (
          <Quiz dispatch={this.props.dispatch} user_profile={this.props.user_profile} tracking={this.props.tracking} dice={this.props.dice} player={this.props.player} quiz={SAMPLES.quiz_example} config={GLOBAL_CONFIG} I18n={I18n}/>
        );
      }
    } else {
      appContent = (
